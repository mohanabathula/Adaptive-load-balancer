...
=======
# 🚗 Advanced Hierarchical Lane Detection

**Real-time detection with road analysis, lane detection, and curvature calculation**
...
python app.py video.mp4      # video file
```
...
│  • Quality analysis                     │
│  • Type classification (highway/city)   │
└──────────────┬──────────────────────────┘
               ↓
┌─────────────────────────────────────────┐
│  LEVEL 2: LANE DETECTION                │
│  • CLAHE enhancement                    │
│  • Multi-channel (white + yellow)       │
...
- **FPS & Latency**: Real-time performance
- **Road Type**: Highway / City / Rural
- **Road Quality**: 0-100% surface detection
- **Confidence**: Lane detection reliability
- **Deviation**: Lateral offset (meters)
- **Curvature**: Left & right lane radius (meters)

## Features

✅ **Hierarchical Processing** - Road → Lanes → Curvature  
✅ **Multi-lane Detection** - Left, right, center lanes  
✅ **Curvature Analysis** - Real radius in meters  
✅ **Indian Road Optimized** - Handles varied conditions  
✅ **Temporal Smoothing** - Stable, jitter-free output  
✅ **<50ms Latency** - Real-time autonomous driving ready  

## Performance

| Resolution | FPS | Latency | Memory |
|-----------|-----|---------|--------|
| 640x480 | 30-35 | 28-35ms | 180MB |
| 480x360 | 40-45 | 22-25ms | 140MB |

**Total: ~330 lines of efficient, hierarchical code**
>>>>>>> 67df075 (Add lane detection code)
